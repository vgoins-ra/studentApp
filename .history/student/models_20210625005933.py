...
class Student_Record(models.Model):
    ...
    department = models.ForeignKey(Department = models.ForeignKey(related_name='student_dept', max_length = 100,on_delete=models.CASCADE)
    );
...
class Certificates(models.Model):
    ...
    fullname = models.ForeignKey(Student_Record,related_name='certif_student', max_length = 100, null=True,on_delete=models.CASCADE)
